                ...
                <div className="col-lg-8 mt-lg-4">
                    <div className='row'>
                        ...
                        <div className="col-12 my-3 formulario-address" style={{ paddingRight: "6px" }}>
                            <ul className='list-place-maps'>
                                <li className='mb-2'>Get the coordinates of a place</li>
                                <li>1. On your computer, open <a href="https://www.google.com/maps" target="_blank"> Google Maps</a>.</li>
