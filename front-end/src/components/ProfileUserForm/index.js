                ...
                <div className="col-lg-8">
                    <div className='row'>
                        ...
                        <div className="col-6 mb-3" style={{ paddingLeft: "0px" }}>
                            ...
                            <input type="text" name="postalCode" defaultValue={profileInfo.postcode} className={`form-control title-placeholder ${errors.postalCode ? 'is-invalid' : ''}`} {...register('postalCode')} id="exampleInputCodePostal1" aria-describedby="emailHelp" />
